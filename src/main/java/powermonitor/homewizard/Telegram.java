...
public class Telegram {
    ...
    public ZonedDateTime getTimestampAsDate() {
        return LocalDateTime.parse(getTimestamp(), DateTimeFormatter.ofPattern("yyMMddHHmmss")).atZone(ZoneId.of("Europe/Brussels"));
    }
    ...
    public ZonedDateTime getMontlyPowerPeakTimestampAsDate() {
        return LocalDateTime.parse(getMontly_power_peak_timestamp(), DateTimeFormatter.ofPattern("yyMMddHHmmss")).atZone(ZoneId.of("Europe/Brussels"));
    }
